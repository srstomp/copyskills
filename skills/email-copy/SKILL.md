...
|------------|----------|-----------|-----------------|
| `cold-outreach` | Cold outreach email | PAS | `email-copy/references/cold-outreach.md` |
| `cold-follow-up` | Follow-up to cold outreach | PAS | `email-copy/references/cold-outreach.md` |
| `welcome-sequence` | Welcome sequence (1-5 emails) | BAB | `email-copy/references/sequences.md` |
| `onboarding-sequence` | Onboarding sequence (5-7 emails) | BAB | `email-copy/references/sequences.md` |
| `nurture-sequence` | Nurture/drip sequence | PAS | `email-copy/references/sequences.md` |
| `re-engagement` | Re-engagement sequence | PAS or BAB | `email-copy/references/sequences.md` |
| `newsletter` | Newsletter (curated, original, or hybrid) | AIDA per section | `email-copy/references/newsletters.md` |
| `transactional` | Transactional email (receipts, confirmations, alerts) | AIDA (lean) | `email-copy/references/newsletters.md` |
| `subject-line` | Subject line only | 4Us + headline formulas | `email-copy/references/subject-lines.md` |
...
- Sequences (welcome, onboarding, nurture, re-engagement): `email-copy/references/sequences.md`
- Cold outreach and cold follow-up: `email-copy/references/cold-outreach.md`
- Subject lines: `email-copy/references/subject-lines.md`
- Newsletters and transactional: `email-copy/references/newsletters.md`

For sequences: check the cadence guidelines in `sequences.md` before drafting. Sending day 1 content on day 3 timing breaks the arc.

For cold outreach: check the first-touch structure in `cold-outreach.md` before drafting a single line. Cold emails longer than 150 words rarely get read.
...
- Respect subject line character limits (check `subject-lines.md` or `cold-outreach.md`)
