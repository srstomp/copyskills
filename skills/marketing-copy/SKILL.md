...
|------------|----------|-----------|-----------------|
| `landing-page-hero` | Landing page hero section | AIDA or 4Ps | `references/landing-pages.md` |
| `landing-page-full` (short) | Full landing page, short-form | AIDA | `references/landing-pages.md` |
| `landing-page-full` (long) | Full landing page, long-form | PASTOR | `references/landing-pages.md` |
| `ad-google` | Google Search ad | 4Us + headline formulas | `references/ad-copy.md` |
| `ad-meta` | Meta/Facebook ad | 4Us + headline formulas | `references/ad-copy.md` |
| `ad-linkedin` | LinkedIn ad | 4Us + headline formulas | `references/ad-copy.md` |
| `value-proposition` | Value proposition | FAB | `references/value-propositions.md` |
| `cta` | Call-to-action copy | AIDA (Action step only) | `references/landing-pages.md` |
| `hero-section` | Hero section (standalone) | AIDA or 4Ps | `references/landing-pages.md` |
...
- Landing pages, hero sections, CTAs: `references/landing-pages.md`
- All ad formats (Google, Meta, LinkedIn): `references/ad-copy.md`
- Value propositions: `references/value-propositions.md`

For ad copy: check character limits in `references/ad-copy.md` before drafting a single word. Drafting without checking limits wastes the revision.
...
For all ad copy (Google, Meta, LinkedIn): check `references/ad-copy.md` for character limits before drafting. Character limits are non-negotiable constraints, not guidelines. A Google Search headline that runs 32 characters is a broken ad. Count before you write.
